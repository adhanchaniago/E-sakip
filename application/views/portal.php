...
<html>
   <head>
      ...
      <link rel="stylesheet" href="<?php echo base_url("public/dist/css/main/css/main.css"); ?>">
      ...
      <style>
         body {
			  ...
			  margin-bottom: 0px;
			  background: none;
			  background: url(<?php echo base_url('public/image/icon/bg.jpg'); ?>) no-repeat center center fixed; 
		...
		.trigonal {
			 background: url('<?php echo base_url('public/image/icon2/trigonal.PNG'); ?>') repeat; 
		}
      </style>
   </head>
   <body>
	<nav class="navbar navbar-default" role="navigation">
		<div class="container">
			<div class="navbar-header">
                <img width="55%" src="<?php echo base_url("public/image/icon/logo-main.png"); ?>" class="logo-head" alt="Logo">
			</div>
		</div>
	</nav>
	...
	<div class="container">
		<div class="row">			
			...
			<div class="col-md-3">
		          ...
		          <div class="box box-danger radius blue-bg shadow trigonal">
		            <div class="box-body box-profile ">
		            	 <h3 class="profile-username text-center font-opd enjoy-css">Informasi</h3>
		              <img class="profile-user-img img-responsive bg-blue img-circle" src="<?php echo base_url("public/image/icon2/info.jpg"); ?>" alt="Login logo" >
		              	<br>		           
			...
			<div class="col-md-3">
		          ...
		          <div class="box box-primary radius blue-bg shadow trigonal">
		            <div class="box-body box-profile ">
		              ...
		              <img class="profile-user-img img-responsive bg-blue img-circle" src="<?php echo base_url("public/image/icon2/kontak.jpg"); ?>" alt="kontak logo">
		              	<br>		           
			...
			<div class="col-md-3">
		          ...
		          <div class="box box-primary radius blue-bg shadow trigonal">
		            <div class="box-body box-profile ">
		              ...
		              <img class="profile-user-img img-responsive bg-blue img-circle" src="<?php echo base_url("public/image/icon2/public.jpg"); ?>" alt="Login logo">
		              	<br>		           
			...
			<div class="col-md-3">
		          ...
		          <div class="box box-primary radius blue-bg shadow trigonal">
		            <div class="box-body box-profile ">
		            	<a href="<?php echo site_url('login?from_url='.$this->input->get('from_url')); ?>"><h3 class="profile-username text-center font-opd enjoy-css">Login</h3></a>
		              <img  class="profile-user-img img-responsive bg-blue img-circle" src="<?php echo base_url("public/image/icon2/login.jpg"); ?>" alt="Login logo">
		              	<br>		           
